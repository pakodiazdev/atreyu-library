...
public class BookSeederProd extends OnceSeeder {
    ...
    @Override
    protected void seed() {
        seedBook("Cien años de soledad", "Gabriel García Márquez", "Realismo mágico", 1967,
        ...
        seedBook("El señor de los anillos", "J.R.R. Tolkien", "Fantasía", 1954,
        ...
        seedBook("1984", "George Orwell", "Distopía", 1949,
        ...
        seedBook("Don Quijote de la Mancha", "Miguel de Cervantes", NOVELA, 1605,
        ...
        seedBook("Crimen y castigo", "Fiódor Dostoyevski", "Novela psicológica", 1866,
        ...
        seedBook("El principito", "Antoine de Saint-Exupéry", "Fábula", 1943,
        ...
        seedBook("Orgullo y prejuicio", "Jane Austen", "Romance", 1813,
        ...
        seedBook("Moby Dick", "Herman Melville", "Aventura", 1851,
        ...
        seedBook("La odisea", "Homero", "Épica", null,
        ...
        seedBook("Frankenstein", "Mary Shelley", "Terror", 1818,
        ...
        seedBook("El retrato de Dorian Gray", "Oscar Wilde", "Novela filosófica", 1890,
        ...
        seedBook("Ulises", "James Joyce", "Modernismo", 1922,
        ...
        seedBook("En busca del tiempo perdido", "Marcel Proust", NOVELA, 1913,
        ...
        seedBook("La metamorfosis", "Franz Kafka", "Surrealismo", 1915,
        ...
        seedBook("El gran Gatsby", "F. Scott Fitzgerald", NOVELA, 1925,
    ...
    private void seedBook(
        ...
        bookService.create(new BookRequest(title, author, genre, year, synopsis));
    }
}
