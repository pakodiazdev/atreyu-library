...
public class BookSeederProd extends OnceSeeder {
    ...
    private List<Book> buildCatalog() {
        return List.of(
            book("Cien años de soledad", "Gabriel García Márquez", "Realismo mágico", 1967,
            ...
            book("El señor de los anillos", "J.R.R. Tolkien", "Fantasía", 1954,
            ...
            book("1984", "George Orwell", "Distopía", 1949,
            ...
            book("Don Quijote de la Mancha", "Miguel de Cervantes", NOVELA, 1605,
            ...
            book("Crimen y castigo", "Fiódor Dostoyevski", "Novela psicológica", 1866,
            ...
            book("El principito", "Antoine de Saint-Exupéry", "Fábula", 1943,
            ...
            book("Orgullo y prejuicio", "Jane Austen", "Romance", 1813,
            ...
            book("Moby Dick", "Herman Melville", "Aventura", 1851,
            ...
            book("La odisea", "Homero", "Épica", null,
            ...
            book("Frankenstein", "Mary Shelley", "Terror", 1818,
            ...
            book("El retrato de Dorian Gray", "Oscar Wilde", "Novela filosófica", 1890,
            ...
            book("Ulises", "James Joyce", "Modernismo", 1922,
            ...
            book("En busca del tiempo perdido", "Marcel Proust", NOVELA, 1913,
            ...
            book("La metamorfosis", "Franz Kafka", "Surrealismo", 1915,
            ...
            book("El gran Gatsby", "F. Scott Fitzgerald", NOVELA, 1925,
