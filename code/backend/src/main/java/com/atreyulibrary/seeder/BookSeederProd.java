...
public class BookSeederProd extends OnceSeeder {
    ...
    private List<Book> buildCatalog() {
        final Set<String> usedInBatch = new HashSet<>();
        return List.of(
            book(usedInBatch, "Cien años de soledad", "Gabriel García Márquez", "Realismo mágico", 1967,
            ...
            book(usedInBatch, "El señor de los anillos", "J.R.R. Tolkien", "Fantasía", 1954,
            ...
            book(usedInBatch, "1984", "George Orwell", "Distopía", 1949,
            ...
            book(usedInBatch, "Don Quijote de la Mancha", "Miguel de Cervantes", NOVELA, 1605,
            ...
            book(usedInBatch, "Crimen y castigo", "Fiódor Dostoyevski", "Novela psicológica", 1866,
            ...
            book(usedInBatch, "El principito", "Antoine de Saint-Exupéry", "Fábula", 1943,
            ...
            book(usedInBatch, "Orgullo y prejuicio", "Jane Austen", "Romance", 1813,
            ...
            book(usedInBatch, "Moby Dick", "Herman Melville", "Aventura", 1851,
            ...
            book(usedInBatch, "La odisea", "Homero", "Épica", null,
            ...
            book(usedInBatch, "Frankenstein", "Mary Shelley", "Terror", 1818,
            ...
            book(usedInBatch, "El retrato de Dorian Gray", "Oscar Wilde", "Novela filosófica", 1890,
            ...
            book(usedInBatch, "Ulises", "James Joyce", "Modernismo", 1922,
            ...
            book(usedInBatch, "En busca del tiempo perdido", "Marcel Proust", NOVELA, 1913,
            ...
            book(usedInBatch, "La metamorfosis", "Franz Kafka", "Surrealismo", 1915,
            ...
            book(usedInBatch, "El gran Gatsby", "F. Scott Fitzgerald", NOVELA, 1925,
    ...
    private Book book(
        ...
        String code;
        do {
            code = codeGenerator.generate(repository);
        } while (usedInBatch.contains(code));
